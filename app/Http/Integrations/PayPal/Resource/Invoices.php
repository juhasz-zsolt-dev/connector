...
class Invoices extends Resource
{
	...
	/**
	 * @param mixed $detail
	 * @param mixed $invoicer
	 * @param mixed $primaryRecipients
	 * @param mixed $items
	 ...
	 * @param mixed $subject
	 * @param mixed $note
	 * @param mixed $sendToRecipient
	 * @param mixed $additionalRecipients
	 * @param mixed $sendToInvoicer
	 */
	 ...
	 * @param mixed $recipientBusinessName
	 * @param mixed $invoiceNumber
	 * @param mixed $status
	 * @param mixed $reference
	 * @param mixed $currencyCode
	 * @param mixed $memo
	 * @param mixed $totalAmountRange
	 * @param mixed $invoiceDateRange
	 * @param string $page The page number to be retrieved, for the list of items. So, a combination of `page=1` and `page_size=20` returns the first 20 invoices. A combination of `page=2` and `page_size=20` returns the next 20 invoices.
