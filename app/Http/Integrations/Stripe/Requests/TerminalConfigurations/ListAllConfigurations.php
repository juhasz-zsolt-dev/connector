 ...
 */
class ListAllConfigurations extends Request
{
	...
	{
		return "/v1/terminal/configurations";
	}
	 ...
	 * @param null|string $isAccountDefault if present, only return the account default or non-default configurations.
	...
	public function __construct(
		...
		protected ?string $isAccountDefault = null,
	...
	public function defaultQuery(): array
	{
		return array_filter([
			...
			'is_account_default' => $this->isAccountDefault,
			'limit' => $this->limit,
