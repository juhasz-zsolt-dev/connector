...
namespace App\Http\Integrations\Stripe\Requests\QuoteLineItems;
 ...
 */
class RetrieveQuoteUpfrontLineItems extends Request
{
	...
	{
		return "/v1/quotes/{$this->quote}/computed_upfront_line_items";
	}
