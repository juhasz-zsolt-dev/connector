 ...
 */
class ListAllOutboundPayments extends Request
{
	...
	/**
	 * @param null|string $customer Only return OutboundPayments sent to this customer.
	 ...
	 * @param null|string $status Only return OutboundPayments that have the given status: `processing`, `failed`, `posted`, `returned`, or `canceled`.
	 */
