 ...
 * List all files
 */
class ListAllFiles extends Request
{
	 ...
	 * @param null|string $purpose The file purpose to filter queries by. If none is provided, files will not be filtered by purpose.
