 ...
 */
class ListAllValueListItems extends Request
{
	 ...
	 * @param null|string $value Return items belonging to the parent list whose value matches the specified value (using an "is like" match).
	 * @param null|string $valueList (Required) Identifier for the parent value list this item belongs to.
	 */
