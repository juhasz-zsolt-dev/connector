 ...
 */
class ListAllInboundTransfers extends Request
{
	 ...
	 * @param null|string $status Only return InboundTransfers that have the given status: `processing`, `succeeded`, `failed` or `canceled`.
	 */
