 ...
 * List all refunds
 */
class ListAllRefunds extends Request
{
    ...
    /**
     * @param  null|string  $charge Only return refunds for the charge specified by this charge ID.
     ...
     * @param  null|string  $paymentIntent Only return refunds for the PaymentIntent specified by this ID.
