 ...
 * List all disputes
 */
class ListAllDisputes extends Request
{
	...
	/**
	 * @param null|string $createdgt Select Issuing disputes that were created during the given date interval.
	 * @param null|string $createdgte Select Issuing disputes that were created during the given date interval.
	 * @param null|string $createdlt Select Issuing disputes that were created during the given date interval.
	 * @param null|string $createdlte Select Issuing disputes that were created during the given date interval.
	 ...
	 * @param null|string $status Select Issuing disputes with the given status.
	 * @param null|string $transaction Select the Issuing dispute for the given transaction.
	 */
