 ...
 */
class ListAllPaymentLinks extends Request
{
	...
	/**
	 * @param null|string $active Only return payment links that are active or inactive (e.g., pass `false` to list all inactive payment links).
