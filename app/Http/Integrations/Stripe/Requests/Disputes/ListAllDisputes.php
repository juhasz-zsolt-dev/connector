...
class ListAllDisputes extends Request
{
    ...
    /**
     * @param  null|string  $charge Only return disputes associated to the charge specified by this charge ID.
     ...
     * @param  null|string  $paymentIntent Only return disputes associated to the PaymentIntent specified by this PaymentIntent ID.
