 ...
 */
class ListAllPromotionCodes extends Request
{
	...
	/**
	 * @param null|string $active Filter promotion codes by whether they are active.
	 * @param null|string $code Only return promotion codes that have this case-insensitive code.
	 * @param null|string $coupon Only return promotion codes for this coupon.
	 ...
	 * @param null|string $customer Only return promotion codes that are restricted to this customer.
