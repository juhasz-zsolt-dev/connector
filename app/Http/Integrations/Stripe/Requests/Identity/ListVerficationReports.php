...
/**
 * List VerficationReports
 */
class ListVerficationReports extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return '/v1/identity/verification_reports';
    }
     ...
     * @param  null|string  $type Only return VerificationReports of this type
     * @param  null|string  $verificationSession Only return VerificationReports created by this VerificationSession ID. It is allowed to provide a VerificationIntent ID.
     */
    public function __construct(
        ...
        protected ?string $verificationSession = null,
    ) {
    }
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'type' => $this->type,
            'verification_session' => $this->verificationSession,
        ]);
    }
}
