...
class ListAllCustomers extends Request
{
	 ...
	 * @param null|string $email A case-sensitive filter on the list based on the customer's `email` field. The value must be a string.
	 ...
	 * @param null|string $testClock Provides a list of customers that are associated with the specified test clock. The response will not include customers with test clocks if this parameter is not set.
	 */
