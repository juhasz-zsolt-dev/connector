 ...
 */
class ListPortalConfigurations extends Request
{
	...
	/**
	 * @param null|string $active Only return configurations that are active or inactive (e.g., pass `true` to only list active configurations).
	 ...
	 * @param null|string $isDefault Only return the default or non-default configurations (e.g., pass `true` to only list the default configuration).
