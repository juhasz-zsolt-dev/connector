 ...
 * List all top-ups
 */
class ListAllTopUps extends Request
{
    ...
    /**
     * @param  null|string  $amountgt A positive integer representing how much to transfer.
     * @param  null|string  $amountgte A positive integer representing how much to transfer.
     * @param  null|string  $amountlt A positive integer representing how much to transfer.
     * @param  null|string  $amountlte A positive integer representing how much to transfer.
     ...
     * @param  null|string  $status Only return top-ups that have the given status. One of `canceled`, `failed`, `pending` or `succeeded`.
     */
    public function __construct(
        protected ?string $amountgt = null,
        protected ?string $amountgte = null,
        protected ?string $amountlt = null,
        protected ?string $amountlte = null,
    ...
    {
        return array_filter([
            'amount[gt]' => $this->amountgt,
            'amount[gte]' => $this->amountgte,
            'amount[lt]' => $this->amountlt,
            'amount[lte]' => $this->amountlte,
