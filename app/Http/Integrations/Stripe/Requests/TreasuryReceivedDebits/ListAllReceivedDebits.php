 ...
 */
class ListAllReceivedDebits extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return '/v1/treasury/received_debits';
    }
     ...
     * @param  null|string  $financialAccount (Required) The FinancialAccount that funds were pulled from.
     ...
     * @param  null|string  $status Only return ReceivedDebits that have the given status: `succeeded` or `failed`.
     */
