 ...
 * List all file links
 */
class ListAllFileLinks extends Request
{
	 ...
	 * @param null|string $expired Filter links by their expiration status. By default, all links are returned.
	 * @param null|string $file Only return links for the given file.
