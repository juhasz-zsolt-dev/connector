 ...
 */
class ListAllDebitReversals extends Request
{
     ...
     * @param  null|string  $receivedDebit Only return DebitReversals for the ReceivedDebit ID.
     * @param  null|string  $resolution Only return DebitReversals for a given resolution.
     * @param  null|string  $startingAfter A cursor for use in pagination. `starting_after` is an object ID that defines your place in the list. For instance, if you make a list request and receive 100 objects, ending with `obj_foo`, your subsequent call can include `starting_after=obj_foo` in order to fetch the next page of the list.
     * @param  null|string  $status Only return DebitReversals for a given status.
     */
    public function __construct(
        ...
        protected ?string $receivedDebit = null,
    ...
    public function defaultQuery(): array
    {
        return array_filter([
            ...
            'limit' => $this->limit,
            'received_debit' => $this->receivedDebit,
