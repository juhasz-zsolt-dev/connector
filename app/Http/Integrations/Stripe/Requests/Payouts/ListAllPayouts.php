 ...
 * List all payouts
 */
class ListAllPayouts extends Request
{
	...
	/**
	 * @param null|string $arrivalDategt
	 * @param null|string $arrivalDategte
	 * @param null|string $arrivalDatelt
	 * @param null|string $arrivalDatelte
	 * @param null|string $createdgt
	 * @param null|string $createdgte
	 * @param null|string $createdlt
	 * @param null|string $createdlte
	 * @param null|string $destination The ID of an external account - only return payouts sent to this external account.
	 ...
	 * @param null|string $status Only return payouts that have the given status: `pending`, `paid`, `failed`, or `canceled`.
	 */
	public function __construct(
		protected ?string $arrivalDategt = null,
		protected ?string $arrivalDategte = null,
		protected ?string $arrivalDatelt = null,
		protected ?string $arrivalDatelte = null,
	...
	{
		return array_filter([
			'arrival_date[gt]' => $this->arrivalDategt,
			'arrival_date[gte]' => $this->arrivalDategte,
			'arrival_date[lt]' => $this->arrivalDatelt,
			'arrival_date[lte]' => $this->arrivalDatelte,
