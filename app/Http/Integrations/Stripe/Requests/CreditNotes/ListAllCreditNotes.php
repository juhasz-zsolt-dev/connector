 ...
 */
class ListAllCreditNotes extends Request
{
	...
	/**
	 * @param null|string $customer Only return credit notes for the customer specified by this customer ID.
	 ...
	 * @param null|string $invoice Only return credit notes for the invoice specified by this invoice ID.
