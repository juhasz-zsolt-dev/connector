 ...
 */
class ListAllEarlyFraudWarnings extends Request
{
	...
	{
		return "/v1/radar/early_fraud_warnings";
	}


	/**
	 * @param null|string $charge Only return early fraud warnings for the charge specified by this charge ID.
	 ...
	 * @param null|string $paymentIntent Only return early fraud warnings for charges that were created by the PaymentIntent specified by this PaymentIntent ID.
