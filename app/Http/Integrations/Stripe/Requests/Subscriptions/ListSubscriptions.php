...
class ListSubscriptions extends Request
{
	 ...
	 * @param null|string $currentPeriodEndgt
	 * @param null|string $currentPeriodEndgte
	 * @param null|string $currentPeriodEndlt
	 * @param null|string $currentPeriodEndlte
	 * @param null|string $currentPeriodStartgt
	 * @param null|string $currentPeriodStartgte
	 * @param null|string $currentPeriodStartlt
	 * @param null|string $currentPeriodStartlte
