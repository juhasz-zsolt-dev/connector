...
class Subscriptions extends Resource
{
	 ...
	 * @param string $currentPeriodEndgt
	 * @param string $currentPeriodEndgte
	 * @param string $currentPeriodEndlt
	 * @param string $currentPeriodEndlte
	 * @param string $currentPeriodStartgt
	 * @param string $currentPeriodStartgte
	 * @param string $currentPeriodStartlt
	 * @param string $currentPeriodStartlte
